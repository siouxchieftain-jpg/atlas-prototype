...
(function () {
  ...
  var MODAL = {
    no: '<h2>Velkommen til en konseptprototype</h2>' +
      ...
      '<p><strong>Vi trenger ikke</strong> tilbakemelding på farger, skrift, layout eller at det er en skisse. Se forbi det uferdige, til selve ideen.</p>' + '<p><strong>Vanlige spørsmål</strong></p>' + '<p><strong>Vi bruker DIPS, kan dette brukes?</strong> Tenk deg at det er bygget inn i DIPS med data ferdig utfylt. Vi tester ideen, ikke integrasjonen.</p>' + '<p><strong>Bestemmer systemet for meg?</strong> Nei. Du plasserer gråsonen, konfidensen er din, og informasjonskompasset er en veiledning du kan overstyre uten straff.</p>' + '<p><strong>Blir mønsteret mitt delt eller overvåket?</strong> Nei. Ditt mønster er kun synlig for deg. Spesialisten ser bare aggregerte tall.</p>' + '<p><strong>Er dette mer arbeid?</strong> Feltene er tenkt forhåndsutfylt fra DIPS. Vurder om informasjonen, ikke tastingen, ville hjulpet.</p>' + '<p><strong>Hvor er beviset på at det virker?</strong> Dette er en tidlig, formativ test av ideen. Effekt er et senere spørsmål.</p>' + '<p><strong>Hvorfor stole på det ATLAS viser?</strong> ATLAS regner ikke ut eller scorer pasienter. Det viser innspillene klinikerne legger inn, og kriteriene.</p>',
