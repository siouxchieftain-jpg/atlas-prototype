...
(function () {
  ...
  var MODAL = {
    no: '<h2>Velkommen til en konseptprototype</h2>' +
      ...
      '<p><strong>Vi trenger ikke</strong> tilbakemelding på farger, skrift, layout eller at det er en skisse. Se forbi det uferdige, til selve ideen.</p>' + '<p><strong>Vanlige sporsmal</strong></p>' + '<p><strong>Vi bruker DIPS, kan dette brukes?</strong> Tenk deg at det er bygget inn i DIPS med data ferdig utfylt. Vi tester ideen, ikke integrasjonen.</p>' + '<p><strong>Bestemmer systemet for meg?</strong> Nei. Du plasserer grasonen, konfidensen er din, og informasjonskompasset er en veiledning du kan overstyre uten straff.</p>' + '<p><strong>Blir monsteret mitt delt eller overvaket?</strong> Nei. Ditt monster er kun synlig for deg. Spesialisten ser bare aggregerte tall.</p>' + '<p><strong>Er dette mer arbeid?</strong> Feltene er tenkt forhandsutfylt fra DIPS. Vurder om informasjonen, ikke tastingen, ville hjulpet.</p>' + '<p><strong>Hvor er beviset pa at det virker?</strong> Dette er en tidlig, formativ test av ideen. Effekt er et senere sporsmal.</p>' + '<p><strong>Hvorfor stole pa det ATLAS viser?</strong> ATLAS regner ikke ut eller scorer pasienter. Det viser innspillene klinikerne legger inn, og kriteriene.</p>',
    en: '<h2>Welcome to a concept prototype</h2>' +
      ...
      '<p><strong>We do not need</strong> feedback on colours, fonts, layout, or the fact that it is a sketch. Look past the unfinished parts, to the idea itself.</p>' + '<p><strong>Common questions</strong></p>' + '<p><strong>We use DIPS, can this be used?</strong> Imagine it built into DIPS with the data prefilled. We are testing the idea, not the integration.</p>' + '<p><strong>Does the system decide for me?</strong> No. You position the grey zone, the confidence is yours, and the information compass is a guide you can override with no penalty.</p>' + '<p><strong>Is my pattern shared or monitored?</strong> No. Your pattern is visible only to you. The specialist sees only aggregated figures.</p>' + '<p><strong>Is this just more work?</strong> The fields are meant to be prefilled from DIPS. Consider whether the information, not the typing, would help.</p>' + '<p><strong>Where is the proof it works?</strong> This is an early, formative test of the idea. Effectiveness is a later question.</p>' + '<p><strong>Why trust what ATLAS shows?</strong> ATLAS does not compute or score patients. It surfaces the inputs clinicians enter, and the criteria.</p>'
  };
